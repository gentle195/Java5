...
<br>
<section>
    <form:form action="/nhan-vien/update-nhan-vien/${nhanVien.id}" method="post" onsubmit="return checkUpdate()"
        ...
        <table class="table table-info table-striped">
            ...
            <tr>
                ...
                <td style="text-align: center" colspan="2">
                    <button type="submit" class="btn btn-secondary">Sửa Nhân Viên</button>
                </td>
                <td></td>
