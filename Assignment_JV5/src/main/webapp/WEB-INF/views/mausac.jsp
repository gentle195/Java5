...
<section>
    <div class="container text-center">
        <form:form action="/mau-sac/add-mau-sac" method="post" modelAttribute="mauSac" onsubmit="return checkAdd()">
            <table class="table table-info table-striped">
                <tr>

                    <th style="text-align: center"><form:label path="ma">Mã Màu Sắc</form:label></th>
                    <th style="text-align: center"><form:label path="ten">Tên Màu Sắc</form:label></th>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: center" colspan="2">
                        <button type="submit" class="btn btn-secondary">Thêm Màu Sắc</button>
                    </td>
                </tr>
            </table>
        </form:form>
        ...
        <br>
        <hr>
        <form action="/mau-sac/search-mau-sac" method="post">
            <table class="table table-danger table-striped">
                ...
                <tr>
                    <td style="text-align: center">
                        <button class="btn btn-secondary">Tìm Màu Sắc</button>
                    </td>
                </tr>
            </table>
        </form>
        ...
        <table class="table table-info table-striped">
            ...
            <c:forEach items="${list}" var="mauSac">
                <tr>
                    ...
                    <td>${mauSac.ten}</td>
                    <td>
                        <a href="/mau-sac/detail-mau-sac/${mauSac.id}" class="btn btn-success "
                           tabindex="-1"
                           role="button"
                           onclick="return checkDetail()">Detail</a>
                        <a href="/mau-sac/view-update-mau-sac/${mauSac.id}" class="btn btn-success "
                           tabindex="-1"
                           role="button"
                           aria-disabled="true" onclick="return checkViewUpdate()">Update</a>
                        <a href="/mau-sac/remove-mau-sac/${mauSac.id}" class="btn btn-success "
                           tabindex="-1"
                           role="button"
