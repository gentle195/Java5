...
<section>
    <div class="container text-center">
        <form:form action="/cua-hang/add-cua-hang" method="post" modelAttribute="cuaHang" onsubmit="return checkAdd()">
            <table class="table table-info table-striped">
                <tr>
                    ...
                    <th style="text-align: center"><form:label path="ten">Địa Chỉ Cửa Hàng</form:label></th>
                    <th style="text-align: center"><form:label path="ten">Thành Phố Cửa Hàng</form:label></th>
                    <th style="text-align: center"><form:label path="ten">Quốc Gia Cửa Hàng</form:label></th>
                </tr>
                <tr>
        ...
        <br>
        <hr>
        <form action="/cua-hang/search-cua-hang" method="post">
