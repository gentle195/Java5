...
<section>
    <div class="container text-center">
        <form:form action="/chuc-vu/add-chuc-vu" method="post" modelAttribute="chucVu" onsubmit="return checkAdd()">
            <table class="table table-info table-striped">
                ...
                <tr>
                    <td style="text-align: center" colspan="2">
                        <button type="submit" class="btn btn-secondary">Thêm Chức Vụ</button>
                    </td>
                </tr>
            </table>
        </form:form>
            ...
            <table class="table table-danger table-striped">
                ...
                <tr>
                    <td style="text-align: center">
                        <button class="btn btn-secondary">Tìm Chức Vụ</button>
                    </td>
                </tr>
            </table>
        </form>
        ...
        <table class="table table-info table-striped">
            ...
            <c:forEach items="${list}" var="chucVu">
                <tr>
                    ...
                    <td>${chucVu.ten}</td>
                    <td>
                        <a href="/chuc-vu/detail-chuc-vu/${chucVu.id}" class="btn btn-success "
                           tabindex="-1"
                           role="button"
                           onclick="return checkDetail()">Detail</a>
                        <a href="/chuc-vu/view-update-chuc-vu/${chucVu.id}" class="btn btn-success "
                           tabindex="-1"
                           role="button"
                           aria-disabled="true" onclick="return checkViewUpdate()">Update</a>
                        <a href="/chuc-vu/remove-chuc-vu/${chucVu.id}" class="btn btn-success "
                           tabindex="-1"
                           role="button"
