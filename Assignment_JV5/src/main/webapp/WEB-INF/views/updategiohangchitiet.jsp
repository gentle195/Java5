...
<br>
<section>
    <form:form action="/gio-hang-chi-tiet/update-gio-hang-chi-tiet/${gioHangChiTiet.id.gioHang.id}/${gioHangChiTiet.id.chiTietSanPham.id}" method="post"
        ...
        <div class="container text-center">
            <table class="table table-info table-striped" style="text-align: center">
                ...
                <tr>
                    <td colspan="6">
                        <button type="submit" class="btn btn-secondary">Sửa Giỏ Hàng Chi Tiết</button>
                    </td>
                </tr>
            </table>
        </div>
