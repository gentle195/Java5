...
<br>
<section>
    <form:form action="/hoa-don-chi-tiet/update-hoa-don-chi-tiet/${hoaDonChiTiet.id.hoaDon.id}/${hoaDonChiTiet.id.chiTietSanPham.id}" method="post"
               onsubmit="return checkAdd()" modelAttribute="hoaDonChiTiet">
        <div class="container text-center">
            <table class="table table-info table-striped" style="text-align: center">
                ...
                <tr>
                    <td colspan="4">
                        <button type="submit" class="btn btn-secondary">Sửa Hóa Đơn Chi Tiết</button>
                    </td>
                </tr>
            </table>
        </div>
