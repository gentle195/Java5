...
<section>
    <div class="container text-center">
        <form:form action="/dong-san-pham/add-dong-san-pham" method="post" modelAttribute="dongSanPham" onsubmit="return checkAdd()">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center pagination-lg">
                ...
                <li class="page-item"><a class="page-link" href="/dong-san-pham/hien-thi?pageNum=${total-1}">Last</a>
                </li>
            </ul>
        </nav>
